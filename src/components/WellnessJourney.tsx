      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 sm:mb-18">
          ...
          <div className="hidden lg:block relative">
            ...
            <div className="absolute top-[48px] left-[7%] right-[7%] h-[2px] bg-[#E8F5EF] -z-0" />
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative mb-5">
                      <div className="w-24 h-24 rounded-2xl bg-[#FFFFFF] border-2 border-[#E8F5EF] group-hover:border-[#087A5A]/50 shadow-sm transition-all duration-300 flex flex-col items-center justify-center group-hover:-translate-y-1">
                    ...
                    {/* Step Content */}
                    <div className="p-4 rounded-2xl bg-[#F7FBF8] border border-[#E8F5EF] w-full flex-1 flex flex-col justify-between">
                      <div>
                        <h3 className="text-sm font-extrabold text-[#07563F] tracking-tight mb-2 uppercase">
                          {item.title}
                        </h3>
                        <p className="text-xs text-[#07563F]/80 leading-relaxed font-normal">
                          {item.description}
                        </p>
                      </div>

                      <div className="mt-3 pt-2.5 border-t border-[#E8F5EF] text-[10px] font-semibold text-[#087A5A] uppercase tracking-wider">
                        Phase 0{index + 1}
                      </div>
                    </div>
                  </motion.div>
          ...
          <div className="lg:hidden relative pl-6 sm:pl-8 border-l-2 border-[#E8F5EF] space-y-6 sm:space-y-8">
            {steps.map((item, index) => {
              const Icon = item.icon;
              return (
                <motion.div
                ...
                >
                  ...
                  {/* Step Card */}
                  <div className="p-5 sm:p-6 rounded-[20px] bg-[#F7FBF8] border border-[#E8F5EF] shadow-xs">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <span className="text-xs font-black text-[#087A5A] px-2.5 py-1 rounded-md bg-[#E8F5EF]">
                          STEP {item.step}
                        </span>
                        <h3 className="text-base font-extrabold text-[#07563F] tracking-tight">
                          {item.title}
                        </h3>
                      </div>
          ...
          <div className="relative rounded-[26px] overflow-hidden bg-[#FFFFFF] border border-[#E8F5EF] shadow-lg shadow-[#07563F]/5 p-3 sm:p-4">
            <div className="relative rounded-2xl overflow-hidden aspect-[16/9] sm:aspect-[21/9] bg-[#E8F5EF]">
              ...
              <div className="absolute bottom-3 left-3 right-3 sm:bottom-5 sm:left-5 sm:right-5">
                <div className="bg-[#FFFFFF]/95 backdrop-blur-md rounded-xl p-4 border border-[#E8F5EF] shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
        ...
        >
          <div className="rounded-[24px] bg-[#F7FBF8] border border-[#E8F5EF] p-6 sm:p-8 lg:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
            <div className="text-center md:text-left">
              ...
              <p className="text-sm sm:text-base text-[#07563F]/80 mt-2 max-w-xl leading-relaxed font-normal">
